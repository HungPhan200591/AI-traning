...
2.  **Tối ưu hóa (Optimize)**: Viết lại prompt sử dụng framework **C.G.C.F** (Context - Goal - Constraints - Format/Response) hoặc cấu trúc tương tự để đảm bảo tính rõ ràng và đầy đủ.
...
4.  **Review (BẮT BUỘC)**: Hỏi người dùng: "Bạn có hài lòng với prompt này không? Bạn muốn sửa gì thêm hay để tôi thực thi luôn?"
    - Không được tự động thực thi prompt luôn, chỉ được chat trả lại người dùng **Prompt Đã Tối Ưu**
5.  **Thực thi (Execute)**:
